...
## Project 5 (Keyboard Key Identifier)
...
```
## Project 6 (Random colour generator)
HTML
```
<!DOCTYPE html>
<html lang="en">
...
const changeBgcolor = () => {
  document.querySelector('body').style.backgroundColor = `rgb(${randomNum(
    255
  )}, ${randomNum(255)}, ${randomNum(255)})`;
  console.log('Hiii');
};
